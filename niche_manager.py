...
DEFAULT_NICHES: dict[str, dict[str, Any]] = {
    ...
    "Luna": {
        "primary_niche": "Mini Movies",
        "subtopics": ["mystery", "romance", "thriller", "science fiction", "viewer-choice stories"],
        "keywords": ["mystery", "storytime", "short film", "romance", "thriller", "plot twist"],
        "audience": "Short-drama and mystery viewers aged 16-34",
        "competitors": [],
        "products": ["platform views", "sponsors", "memberships", "story compilations"],
        "avoid_topics": ["graphic violence", "real-person impersonation", "copyrighted franchises"],
        "languages": ["English", "Italian"],
        "platforms": ["TikTok", "YouTube Shorts", "Instagram Reels"],
        "content_pillars": ["hook", "clue", "danger", "reveal", "viewer decision"],
    },
}
